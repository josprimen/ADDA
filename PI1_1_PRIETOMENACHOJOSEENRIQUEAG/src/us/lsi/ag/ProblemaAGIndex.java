...
public interface ProblemaAGIndex<S> extends ProblemaAG {	
	...
	default Integer getMax(int index){ //Número máximo de veces que se repite un objeto para todos los objetos dices cual sera su máx.
	 ...
	 */
	S getSolucion(IndexChromosome cr); //Devuelve la solución de un cromosoma  Comosoma-> xxxxxx--> solucion
